-- Fix hybrid_search to exclude archived memories.
-- Without this, archived memories leak into text-based search results
-- even though pure semantic search and list_memories both filter them.
