-- F-01: Add bank_id parameter to hybrid_search function.
-- Matches the deployed function signature and application code in src/db/memories.py.
-- The previous version (migration 002) only filtered by user_id, not bank_id,
-- which could leak search results across banks for the same user.
